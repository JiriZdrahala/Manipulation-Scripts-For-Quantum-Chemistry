...
def plot_ecd_spectra(calc_file, ffr_file, combined_file,isRoa, output_image):
    ...
    # for ax in [ax1,ax2,ax3]:
    #     # Get all the major tick label objects from your bottom axis
    #     labels = ax.get_xmajorticklabels()

    #     # Loop through them and hide every other label (even indices)
    #     for index, label in enumerate(labels):
    #         if index % 2 != 0:  # Adjust this condition to skip every 3rd, 4th, etc.
